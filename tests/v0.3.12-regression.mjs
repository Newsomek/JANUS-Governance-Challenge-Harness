...
assert(
  indexText.includes('<title>JANUS Governance Challenge Harness v0.3.12</title>'),
  'Public page title is not v0.3.12.'
);

assert(
  indexText.includes('EXTERNAL ARCHITECTURAL CONFORMANCE CHALLENGE · VERSION 0.3.12'),
  'Visible page eyebrow is not v0.3.12.'
);

assert(
  indexText.includes('<strong>JANUS Governance Challenge Harness v0.3.12</strong>'),
  'Public page footer is not v0.3.12.'
);
...
assert(expectedHashes.version === '0.3.9', 'Expected contract hash metadata version mismatch.');
...
console.log('JANUS v0.3.12 automated regression: PASS');
