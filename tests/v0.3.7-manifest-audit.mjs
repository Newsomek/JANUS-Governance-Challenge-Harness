...
assert(manifest.version === '0.3.7', 'Manifest version must be 0.3.7.');
assert(manifest.build_id === 'janus-governance-challenge-harness-v0.3.7', 'Manifest build ID mismatch.');
...
console.log(`JANUS v0.3.7 release manifest audit: PASS (${tracked.length}/${tracked.length} tracked files; build-info.json excluded from self-hash)`);
