...
const build = {
  version: '1.0',
  build_id: 'janus-governance-challenge-harness-v1.0',
...
assert(
  indexText.includes('<title>JANUS Governance Challenge Harness v1.0</title>'),
  'Public page title is not v1.0.'
);

assert(
  indexText.includes('EXTERNAL ARCHITECTURAL CONFORMANCE CHALLENGE · VERSION 1.0'),
  'Visible page eyebrow is not v1.0.'
);

assert(
  indexText.includes('<strong>JANUS Governance Challenge Harness v1.0</strong>'),
  'Public page footer is not v1.0.'
);
...
console.log('JANUS v1.0 automated regression: PASS');
