...
assert(
  indexText.includes('<title>JANUS Governance Challenge Harness v0.3.13</title>'),
  'Public page title is not v0.3.13.'
);

assert(
  indexText.includes('EXTERNAL ARCHITECTURAL CONFORMANCE CHALLENGE · VERSION 0.3.13'),
  'Visible page eyebrow is not v0.3.13.'
);

assert(
  indexText.includes('<strong>JANUS Governance Challenge Harness v0.3.13</strong>'),
  'Public page footer is not v0.3.13.'
);
...
console.log('JANUS v0.3.13 automated regression: PASS');
