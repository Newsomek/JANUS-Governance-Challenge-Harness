...
if (
  ...
  throw new Error(
    "Explicit expected code commit is required."
  );
}
...
if (
  ...
  throw new Error(
    "Explicit expected code tree is required."
  );
}
...
if (untracked.length !== 0) {
  throw new Error(
    "Cannot bind while unrelated untracked files exist: " +
    untracked.join(", ")
  );
}
...
console.log(
  "JANUS v0.3.11 RELEASE STATE BOUND."
);
