...
assert(manifest.version === '0.3.10', 'Manifest version must be 0.3.10.');
assert(manifest.build_id === 'janus-governance-challenge-harness-v0.3.10', 'Manifest build ID mismatch.');
...
console.log(`JANUS v0.3.10 release manifest audit: PASS (${tracked.length}/${tracked.length} tracked files; build-info.json excluded from self-hash)`);
